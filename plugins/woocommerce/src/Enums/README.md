...
- [CatalogDisplayMode](./CatalogDisplayMode.php) - Enumerates the possible values of the `woocommerce_shop_page_display` and `woocommerce_category_archive_display` options.
